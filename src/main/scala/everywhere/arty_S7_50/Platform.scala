...
//-------------------------------------------------------------------------
// ArtyS7DevKitPlatformIO
//-------------------------------------------------------------------------

class ArtyS7DevKitPlatformIO(implicit val p: Parameters) extends Bundle {
  val pins = new Bundle {
...
//-------------------------------------------------------------------------
// ArtyS7DevKitPlatform
//-------------------------------------------------------------------------

class ArtyS7DevKitPlatform(implicit val p: Parameters) extends Module {
  val sys = Module(LazyModule(new ArtyS7DevKitSystem).module)
  val io = new ArtyS7DevKitPlatformIO
